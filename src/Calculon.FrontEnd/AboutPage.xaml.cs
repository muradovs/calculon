...
namespace Calculon.FrontEnd
{
  ...
  public sealed partial class AboutPage
  {
    ...
    public AboutPage()
    {
      ...
      tbTitle.Text = ResourceManager.GetLocalizedString("About command title");
      tbCaption.Text = ResourceManager.GetLocalizedString("ApplicationDisplayName");
      tbContent.Text = ResourceManager.GetLocalizedString("CreatedBy");
